...
For the full collector deployment walkthrough — including Helm chart values, DaemonSet agent features, cluster collector, tail sampling gateway configuration, and eBPF instrumentation — see the [instrumentation guide](docs/instrumentation-guide.md).
